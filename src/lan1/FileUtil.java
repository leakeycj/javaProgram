...
public class FileUtil {
	...
	public void readLines(String file, Map<Integer, String> lineMap) {
		BufferedReader reader = null;
		...
		try {
			...
			while ((line = reader.readLine()) != null) {
				...
				lineMap.put(Integer.parseInt(s[0]), s[1]);
	...
	public static void writeLines(String file, Map<Integer, String> termToIndexMap) {
		BufferedWriter writer = null;
		try {
			writer = new BufferedWriter(new FileWriter(new File(file)));

			Set<?> s = termToIndexMap.entrySet();
	...
	public static void writeListLines(String file, List<String> counts) {
		BufferedWriter writer = null;
	...
	public static void writeSequenceLines(String file, List<Sequence> counts) {
		BufferedWriter writer = null;
	...
	public static void writeMapLines(String file, List<Map.Entry<String, Double>> list) {
		BufferedWriter writer = null;
		try {
			writer = new BufferedWriter(new FileWriter(new File(file)));
...
//			//
//			
//			if(!token.endsWith("/m")&&!token.contains("/w")&&!token.equals("")&&token!=null)
//			{
//				String str=token.toLowerCase().trim().replaceAll("/[a-z][a-z|0-9]*", "");
//				str=str.replaceAll("_new", "");
//				tokens.add(str);
//				//System.out.println(token.toLowerCase().trim().replaceAll("/n", ""));
//			}
//			
//		}
	}
